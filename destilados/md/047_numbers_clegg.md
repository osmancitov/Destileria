---
lote: "047"
slug: "047_numbers_clegg"
titulo: "Are Numbers Real? The Uncanny Relationship of Mathematics and the Physical World"
title: "$titulo$"
autor: "Brian Clegg"
ano_publicacion: "2016"
fecha_lote: "28 agosto 2026"
descripcion: "Un físico rastrea la historia de las matemáticas preguntando si los números existen más allá de la mente humana."
extracto: "El corpus llega como un libro que abre preguntas que la escuela cerró demasiado pronto."
idioma: "Inglés"
genero: "Divulgación científica / Historia de las matemáticas"
extension: "~78,500 palabras / ~314 páginas / 15 capítulos"
palabra_frecuente: "Real"
imagen_w: "992"
imagen_h: "1586"
---
...
<div class="prompt-imagen">
  <div class="prompt-imagen-cabecera"><strong>El peso de lo que no pesa</strong></div>
  <figure class="img-container">
    <img src="img/047_numbers_clegg_presentacion_1.jpg"
         alt="El peso de lo que no pesa"
         width="992"
         height="1586"
         loading="lazy">
  </figure>
...
<div class="prompt-imagen">
  <div class="prompt-imagen-cabecera"><strong>Lo que no se puede mostrar</strong></div>
  <figure class="img-container">
    <img src="img/047_numbers_clegg_atmosfera_1.jpg"
         alt="Lo que no se puede mostrar"
         width="816"
         height="1312"
         loading="lazy">
  </figure>
...
<div class="prompt-imagen">
  <div class="prompt-imagen-cabecera"><strong>El momento entre dos estados</strong></div>
  <figure class="img-container">
    <img src="img/047_numbers_clegg_atmosfera_2.jpg"
         alt="El momento entre dos estados"
         width="816"
         height="1312"
         loading="lazy">
  </figure>
...
**Título** — *Are Numbers Real? The Uncanny Relationship of Mathematics and the Physical World*
**Autor** — Brian Clegg
**Año** — 2016 (St. Martin's Press)
**Género** — Divulgación científica / Historia y filosofía de las matemáticas
**Extensión estimada** — ~78,500 palabras / ~314 páginas (a 250 palabras/página) / 15 capítulos + notas e índice
**Idioma original** — Inglés
**Palabra más frecuente con contenido** — *Real*. Confirma: es lo que el corpus declara ser —la pregunta sobre la realidad de los números— y a la vez lo que más pone en cuestión. La palabra habita el título y regresa como fantasma a lo largo del texto.
...
**Figuras clave:**
- **Pitágoras** — fundador legendario del culto que afirmó que el universo está construido sobre números enteros; su escuela descubrió el problema que no podía resolver.
- **Hippasus** — el pitagórico que, según la leyenda, fue asesinado por revelar la existencia de los irracionales.
- **Euclides** — organizador del modelo axiomático que separó las matemáticas del trabajo sucio de medir y contar.
- **Isaac Newton / Gottfried Leibniz** — inventores simultáneos del cálculo; el corpus los usa como bisagra entre las matemáticas al servicio de la ciencia y las matemáticas como lenguaje privilegiado.
- **Georg Cantor** — creador de la teoría de conjuntos e inventor de la jerarquía de infinitos; su trabajo lleva al límite la pregunta de si la abstracción matemática toca algo real.
- **Max Tegmark** — físico contemporáneo que propone que el universo *es* matemático; representa el extremo que el corpus quiere interrogar.
- **Zeno de Elea** — sus paradojas (Aquiles y la tortuga) aparecen como primer ejemplo histórico de las tensiones entre lo que las matemáticas dicen y lo que la experiencia muestra.
...
## Capítulo 4: Perfección elegante
...
## Capítulo 6: La emergencia de la nada
...
## Capítulo 7: El que es ignorante
...
## Capítulo 8: Todo en la imaginación
...
## Capítulo 9: El asombroso universo mecánico matemático
...
## Capítulo 10: El misterio del "quizás"
...
## Capítulo 11: El martillo matemático de Maxwell
...
## Capítulo 12: El infinito y más allá
...
## Capítulo 13: Misterios matemáticos del siglo XX
...
## Capítulo 14: Juegos de simetría
